...
def test_raw_data_file_exists():
    ...
    raw_data_file = _PATH_DATA / 'raw_data' / 'DK_load_raw.csv'
...
def test_raw_data_values_are_positive():
...
def test_raw_data_is_hourly_resolution():
...
def test_raw_data_values_are_realistic():
...
def test_processed_data_directory_exists():
    ...
    processed_path = _PATH_DATA / 'processed_data'
    
    if processed_path.exists():
        assert processed_path.is_dir()


def test_processed_data_can_be_loaded():
    """Test loading processed data if it exists."""
    processed_file = _PATH_DATA / 'processed_data' / 'DK_load_processed.csv'
...
def test_processed_data_load_values_are_positive():
...
def test_processed_data_is_hourly_resolution():
...
def test_temporal_features_in_valid_range():
...
def test_train_val_test_splits_exist():
    """Test that train/val/test splits can be loaded if they exist."""
    splits_path = _PATH_DATA / 'processed_data' / 'splits'
...
def test_splits_have_no_missing_values():
...
def test_splits_have_positive_load_values():
...
def test_splits_are_hourly_resolution():
